...
namespace H.API.PRINCIPAL.Controllers
{
    ...
    [ApiController]
    public class TortaImagenController : ControllerBase
    {
        private IUnitOfWork unitOfWork;
        private readonly ICloudinaryService _cloudinaryService;

        public TortaImagenController(IUnitOfWork unitOfWork, ICloudinaryService cloudinaryService)
        {
        ...
        [HttpPost("Insertar")]
        public IActionResult Insert([FromBody] TortaImagen producto)
        {
            try
            {
                var servicio = new TortaImagenService(unitOfWork, _cloudinaryService);
        ...
        [HttpPut("Modificar")]
        public IActionResult Update([FromBody] TortaImagen producto)
        {
            try
            {
                var servicio = new TortaImagenService(unitOfWork, _cloudinaryService);
        ...
        public async Task<IActionResult> InsertarConImagen([FromForm] TortaImagen producto, IFormFile? imagen)
        {
            try
            {
                var servicio = new TortaImagenService(unitOfWork, _cloudinaryService);
        ...
        public async Task<IActionResult> ModificarConImagen([FromForm] TortaImagen producto, IFormFile? imagen)
        {
            try
            {
                var servicio = new TortaImagenService(unitOfWork, _cloudinaryService);
