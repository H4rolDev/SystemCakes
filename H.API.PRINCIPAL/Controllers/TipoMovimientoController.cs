...
namespace H.API.PRINCIPAL.Controllers
{
    ...
    public class TipoMovimientoController : ControllerBase
    {
        ...
        public TipoMovimientoController(IUnitOfWork unitOfWork, ICloudinaryService cloudinaryService)
        {
            this.unitOfWork = unitOfWork;
        }

        [HttpPost("Insertar")]
        public IActionResult Insert([FromBody] TipoMovimiento producto)
        {
            try
            {
                var servicio = new TipoMovimientoService(unitOfWork);
        ...
        [HttpPut("Modificar")]
        public IActionResult Update([FromBody] TipoMovimiento producto)
        {
            try
            {
                var servicio = new TipoMovimientoService(unitOfWork);
